...
**The** **placement** **of** something or someone is the act of [putting](https://www.collinsdictionary.com/zh/dictionary/english/putt) them in a particular place or position.
...
If something such as a law, a [policy](https://www.collinsdictionary.com/zh/dictionary/english/policy), or an administrative structure is **in place**, it is [working](https://www.collinsdictionary.com/zh/dictionary/english/working) or able to be used.

eg: 

-  the accounts payable manager or clerk should be familiar with EDI operations if EDI invoicing [is in place](https://ediacademy.com/blog/6728-2/).
...
**lag-,law,lay**- [8]:  这是一组同源词，原始含义表示 "to lay, put, place 放下"。其原始印欧语形式为 *legh。law 词义由“放置”引申为“法律”。
...
- EDI document flow or message flow describes the movement of EDI messages to various [inbound and outbound addresses and departments](https://ediacademy.com/blog/how-edi-works-2/) to execute a business process or transaction.
