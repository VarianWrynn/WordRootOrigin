...
| 单词                              | 解释                                                         | 单词                                 | 解释                                                         |
| --------------------------------- | ------------------------------------------------------------ | ------------------------------------ | ------------------------------------------------------------ |
| **hash**<br />【hæʃ】             | Hash 杂烩 => 哈希表<br />n. 剁碎的食物, 杂乱无章的的一大堆, 杂烩, 复述, <br />【计】散列 <br />vt. 切碎, 搞糟 <br /><img src="./images/image-20220212172559666.png" alt="image-20220212172559666" style="zoom: 25%;" /><br />1 - 来自法语 hacher,剁，剁碎，词源同 hatchet.<br />引申词义跺碎的肉丁土豆，拼定比较 bake,batch. | **wild-card**<br />【ˈwaɪldˌkɑrd】   | 未知数;未知因素;(给予没有正常参赛资格的选手准其参加比赛的)“外卡”;“外卡”选手;(用于代替任何字符或字符串的)通配符<br />a playing card that can have any value, suit, color, or other property in a game at the discretion of the player holding it.<br />
