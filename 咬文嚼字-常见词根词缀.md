...
| **ag-greg-ate**                                              | **`ag-`**增加 + **`greg-`**群体 + **`-ate`**, 表动词 → 增加团体 → 聚集。<br />***合计;总计*** | **al-lev-i-ate**<br />al-lev-i-ate                 | **`lev-`** = raise, lighten, 表示“提高，举起，变轻”。源自拉丁语 levis "light."<br />**`al-`**同ad- + **`levi-`**轻 + **`-ate`**动词后缀 → 使轻松 → 缓和 |
